...
- Obstacles are declared as data in `scripts/obstacles.gd` and get matching `StaticBody2D` colliders generated at runtime, so visuals and physics always stay in sync.
...
scenes/main.tscn       # Main scene (player, obstacles, camera, HUD)
